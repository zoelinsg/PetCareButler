...
SECRET_KEY = 'django-insecure-(jfh+@o1%--_30cmuf^fcxb7c)$8v%qzl^oybgkr1x4i=74_c^'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = "PetCareButler"
EMAIL_HOST_USER = os.getenv("OWN_EMAIL_HOST_USER")
EMAIL_HOST_PASSWORD = os.getenv("OWN_EMAIL_HOST_PASSWORD")
